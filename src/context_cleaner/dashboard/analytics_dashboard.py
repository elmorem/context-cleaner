...
class AnalyticsDashboard:
    ...
    def _generate_dashboard_data(self) -> Dict[str, Any]:
        ...
        try:
            ...
            dashboard_data = {
                ...
                "recommendations": [
                    r.to_dict() for r in recommendations[:3]
                ],  # Top 3 recommendations
                "insights": trend_analysis.key_insights[:3],  # Top 3 insights
                "anomalies": trend_analysis.anomalies[:3],  # Top 3 anomalies
                "charts": {
                    "productivity_chart": self._generate_productivity_chart_data(
                        sessions
                    ),
                    "health_score_chart": self._generate_health_score_chart_data(
                        sessions
                    ),
                    "session_distribution": self._generate_session_distribution_chart(
                        sessions
                    ),
                },
            }
    ...
    def _get_current_recommendations(self) -> List[Recommendation]:
        ...
        try:
            ...
            current_context = {"size": 25000, "file_count": 8, "complexity_score": 65}
    ...
    def _session_to_dict(self, session) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "end_time": (
                    getattr(session, "end_time", datetime.now()).isoformat()
        ...
        try:
            ...
            if current_session:
                return {
                    ...
                    "productivity_score": getattr(
                        current_session, "productivity_score", 0
                    ),
                    "health_score": getattr(current_session, "health_score", 0),
                    "context_size": getattr(current_session, "context_size", 0),
                    "focus_time_minutes": getattr(
                        current_session, "focus_time_minutes", 0
                    ),
                }
            else:
                return {
    ...
    def _generate_productivity_chart_data(
    ...
    def _generate_health_score_chart_data(
        self, sessions: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
    ...
    def _generate_session_distribution_chart(
        self, sessions: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
