            ...
            try:
                ...
                if optimize_type in ['memory', 'both']:
                    ...
                    results['memory'] = {
                        ...
                        'saved_mb': round(memory_before.process_mb - memory_after.process_mb, 1)
                    }
        ...
        try:
            ...
            return {
                ...
                'system': {
                    ...
                    'active_threads': cpu_report['scheduler']['scheduling']['active_threads']
                },
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Context Cleaner Real-Time Performance Dashboard')
