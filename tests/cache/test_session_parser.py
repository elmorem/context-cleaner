...
class TestSessionCacheParser:
    ...
    def test_parse_token_metrics(self):
        ...
        assert metrics.total_tokens == 150  # input + output
    ...
    def test_analyze_file_access_patterns(self):
        ...
        tool2 = ToolUsage("Edit", "t2", {"file_path": "/test/file.py"}, now)  # Same file
    ...
    def test_message_content_text_extraction(self):
        ...
        msg1 = SessionMessage(
            ...
            role=MessageRole.USER, content="Simple text", 
        ...
        msg2 = SessionMessage(
            uuid="2", parent_uuid=None, message_type=MessageType.ASSISTANT,
    ...
    def test_context_switch_detection(self):
        ...
        for content in switch_messages:
            msg = SessionMessage(
                uuid="test", parent_uuid=None, message_type=MessageType.USER,
        ...
        normal_msg = SessionMessage(
            uuid="test", parent_uuid=None, message_type=MessageType.USER,
            role=MessageRole.USER, content="Help me debug this function",
            timestamp=datetime.now()
        )
