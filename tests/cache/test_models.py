...
class TestTokenMetrics:
    ...
    def test_token_metrics_creation(self):
        ...
        assert metrics.total_tokens == 500  # Auto-calculated: 100 + 50 + 200 + 150
...
class TestSessionMessage:
    ...
    def test_estimated_tokens_with_metrics(self):
        ...
        assert message.estimated_tokens == 150  # From metrics.total_tokens (100 + 50)

    def test_estimated_tokens_without_metrics(self):
        """Test token estimation without metrics returns 0 (ccusage approach)."""
        ...
        # Returns 0 when no actual metrics available (no fallback estimation)
        assert message.estimated_tokens == 0
